...
const struct race_type race_table [MAX_RACE] =
{
...

	{
		...
		{1,-1,-1,-1,2},
		{1,1,1,0,1,0,1,0},
		 SPEED_NORMAL, MOVE_HEAVY,   VISION_DARK,
		 1,  0,  3,
		"Magic resistance.",
...

	{
		...
		{0,-1,1,1,0},
		{1,1,0,0,1,1,1,0},
		 SPEED_NORMAL, MOVE_HEAVY,   VISION_NORMAL,
		-1,  2,  -1,
		"Forage for food.",
...
const struct skill_type skill_table [MAX_SKILL] =
{
	...
	{
		"anti-magic shell",           { 99, 99, 99, 99, 99, 99, 99, 99 },
	...
	{
		"breath water",               { 99, 99, 99, 99, 57, 99, 99, 99 },
	...
	{
		"burning hands",              { 99, 99, 99, 99,  2, 99, 99, 10 },
	...
	{
		"chill touch",                { 99, 99, 99, 99, 15, 99, 99, 99 },
	...
	{
		"control weather",            { 99, 99, 99, 99, 12, 99, 99, 99 },
	...
	{
		"illusion",                   { 99, 99, 99, 99, 99, 99, 99, 99 },
		spell_illusion,               NULL,
		FSKILL_SPELL,                 SFOL_DUNNO,
		RSKILL_NONE,                  DAM_MAGIC,
		TAR_IGNORE,                   POS_STANDING,
	...
	{
		"metamorphose liquids",       { 99, 99, 99, 99, 99, 99, 99, 99 },
	...
	{
		"riposte",                    { 99, 37, 99, 99, 99, 99, 99, 99 },
		NULL,                         &gsn_riposte,
		FSKILL_NONE,                  SFOL_NONE,
		RSKILL_NONE,                  DAM_NONE,
		TAR_IGNORE,                   POS_STANDING,
	...
	{
		"stone fist",                 { 99, 99, 99, 99, 99, 99, 24, 99 },
	...
	{
		"sword fighting",             {  1,  4, 17, 99, 99, 26, 99, 99 },
