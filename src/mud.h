...
struct tactical_map
{
	...
	unsigned short color[MAX_TACTICAL_ROW * MAX_TACTICAL_COL];
};
...
#define COMM_FLAG_COMMAND       BV07
#define COMM_FLAG_NOINPUT       BV08
...
char      * get_color_diff              args( ( CHAR_DATA *, bool, bool, bool, bool, bool, bool) );
...
int         start_compress              args( ( DESCRIPTOR_DATA *d ) );
...
void        send_will_mssp              args( ( DESCRIPTOR_DATA *d ) );
void        send_will_msdp              args( ( DESCRIPTOR_DATA *d ) );
void        send_will_mccp              args( ( DESCRIPTOR_DATA *d ) );
void        send_do_naws                args( ( DESCRIPTOR_DATA *d ) );
void        send_do_ttype               args( ( DESCRIPTOR_DATA *d ) );
void        send_do_new_environ         args( ( DESCRIPTOR_DATA *d ) );
void        send_will_eor               args( ( DESCRIPTOR_DATA *d ) );
...
int         translate_telopts           args( ( DESCRIPTOR_DATA *d, char *src, int srclen, char *out ) );
