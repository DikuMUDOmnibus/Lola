	...
	if (!IS_NPC(ch))
	{
		...
		*/
		...
		||  IS_SET(to_room->room_flags, ROOM_ALLOW_WLC))
		{
			...
			switch (ch->class)
			{
				case CLASS_RANGER:       belong = IS_SET(to_room->room_flags, ROOM_ALLOW_WAR); break;
				...
				case CLASS_ELEMENTALIST: belong = IS_SET(to_room->room_flags, ROOM_ALLOW_DRU); break;
				case CLASS_ILLUSIONIST:  belong = IS_SET(to_room->room_flags, ROOM_ALLOW_SOR); break;
				case CLASS_MONK:         belong = IS_SET(to_room->room_flags, ROOM_ALLOW_SHA); break;
				case CLASS_NECROMANCER:  belong = IS_SET(to_room->room_flags, ROOM_ALLOW_WLC); break;
			}
